...
private val _ActivityDefinition = LucideIconDefinition("MessageCircleDashed") { strokeWidth ->
    lucidePath(strokeWidth) {
            ...
            lucidePath(strokeWidth) {
                ...
                lineToRelative(-2.906f, .85f)
                arcToRelative(1f, 1f, 0f, false, true, -1.236f, -1.169f)
                lineToRelative(.965f, -2.98f)
            }
}

public val LucideIcons.All.MessageCircleDashedDefinition: LucideIconDefinition
    get() = _ActivityDefinition

public val LucideIcons.All.MessageCircleDashed: ImageVector
    @Composable get() = MessageCircleDashedDefinition.asImageVector()
